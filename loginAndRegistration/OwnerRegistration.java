...
public class OwnerRegistration {
	...
	public OwnerRegistration(Connection con){

		this.con = con;
		regFrame = new JFrame("Owner Registration");

		JLabel oRegLabel = new JLabel("Owner Registration");
		...
		ActionListener regListener = new ActionListener()
		{
			public void actionPerformed(ActionEvent e) 
			{
				...
				String loginQuery = "select ownerUserName from businessowner where ownerUserName = ?";
